      ...
      <MainTemplate>
        <GenericHtml>
          ...
          <p>
            ...
            <RouterLink to='/settings'>página de configurações</RouterLink> e ajustar os minutos
            como preferir.
          </p>
          ...
          <p>
            ...
            <RouterLink to='/history'>histórico</RouterLink>, com status de completas ou
          ...
          <p>
            ...
            <RouterLink to='/'>voltar para a página inicial</RouterLink> e iniciar seus
            Pomodoros! 🍅🚀
          </p>
